...
export function FeedNativeAd() {
  ...
  useEffect(() => {
    const ad = NativeAd.createForAdRequest(AD_UNITS.NATIVE_FEED, {
      requestNonPersonalizedAdsOnly: false,
    });

    const unsubLoaded = ad.addEventListenerForAdEvent(AdEventType.LOADED, () => setNativeAd(ad));
    const unsubError  = ad.addEventListenerForAdEvent(AdEventType.ERROR,  () => { /* silent fail */ });
